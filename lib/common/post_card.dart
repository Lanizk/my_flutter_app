                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Icon(
                          Constants.up,
                          size: 30,
                          color: post.upvotes.contains(user.uid) ? Pallete
                              .redColor : null,
                        ),
                      ),
                      Text(
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          Constants.down,
                          size: 30,
                          color: post.downvotes.contains(user.uid) ? Pallete
                              .blueColor : null,
                        ),
                      ),
                    ],
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ref.watch(getCommunityByNameProvider(
                                    post.communityName)).when(
                                    data: (data) {
                                            ...
                                            child: Padding(
                                              ...
                                              child: GridView.builder(
                                                  ...
                                                  itemBuilder: (
                                                    ...
                                                    print('Loading award: $award');
                                                    print('Image path: ${Constants.awards[award]}');
